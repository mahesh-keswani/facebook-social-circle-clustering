...
print('For n(10) clusters The average silhouette score is {}'.format(silhouette_avg))

# sample_silhouette_values = silhouette_samples(X, y_kmeans)
# with open('silhouette_scores_for_samples.txt', 'w') as f:
...
# Loads data.
dataset = spark.read.format("libsvm").load("facebook_combined.txt")
